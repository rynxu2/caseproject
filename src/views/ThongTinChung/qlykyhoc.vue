            ...
            <div>
                <div class="panel pb-0 mt-6">
                    <div class="datatable">
                        ...
                        >
                            <template #kyhoc="data">
                                    <input type="checkbox" :checked="data.value.kyhoc" disabled style="opacity: 1 !important; position: static !important;"/>
                            </template>
                        </vue3-datatable>
                    </div>
                </div>
